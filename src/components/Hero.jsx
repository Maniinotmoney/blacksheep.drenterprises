...
const Hero = ({ onActivegridTrigger }) => {
    const [content, setContent] = useState({
        heading: 'Explore the DR of Cargo Logistics',
        subheading: 'Real-time tracking, intelligent routing, and global freight solutions powered by advanced logistics technology.',
        statsCount: '20K+',
        statsLabel: 'Global Shipments Delivered'
    });
